...
from app.services.reclamo_processor import process_reclamos_background
...
async def upload_reclamos(
    ...
    try:
        ...
        background_tasks.add_task(process_reclamos_background, file_bytes, file.filename)
        
        return JSONResponse(status_code=202, content={
            "message": "Archivo recibido correctamente. El procesamiento de reclamos (geocodificación) se está ejecutando en segundo plano.",
